...
function StranBody(fobj)
{
	...
	else 
	{
		...
		StranLink_Obj.innerText=BodyIsFt==1?"¼òÌåÖÐÎÄ":"·±ÌåÖÐÎÄ"
...
function setCookie(name, value)		//cookiesÉèÖÃJS
{
...
function getCookie(Name)			//cookies¶ÁÈ¡JS
{
	var search = Name + "="
