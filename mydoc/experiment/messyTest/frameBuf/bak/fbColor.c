...
void draw_dot(uint32_t x, uint32_t y/*, struct Color_Rgb565 c*/)
{
    if (-1L == (long)fb_mem)
    {
...
int main(int argc, char *argv[])
{
	...
	printf("Color_Rgb565 len:%d\n",sizeof(struct Color_Rgb565));
    ...
    for(i=R_START; i<R_START+COLOR_WIDTH; ++i)
	{
        ...
        {
			/*
			struct Color_Rgb565 r;
			memset(&r,0,sizeof(struct Color_Rgb565));
			r.r =~r.r;
			*/
    ...
    for(i=G_START; i<G_START+COLOR_WIDTH; ++i)
	{
        ...
        {
			/*
			struct Color_Rgb565 g;
			memset(&g,0,sizeof(struct Color_Rgb565));
			g.r =~g.r;
			*/
    ...
    for(i=B_START; i<B_START+COLOR_WIDTH; ++i)
	{
        ...
        {
			/*
			struct Color_Rgb565 b;
			memset(&b,0,sizeof(struct Color_Rgb565));
			b.r =~b.r;
			*/
