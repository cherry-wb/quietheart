...
/* BOOLEAN:STRING,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.FXKUXU:1) */
extern void dbus_glib_marshal_server_object_BOOLEAN__STRING_POINTER_POINTER (GClosure     *closure,
                                                                             GValue       *return_value,
...
void
dbus_glib_marshal_server_object_BOOLEAN__STRING_POINTER_POINTER (GClosure     *closure,
...
static const DBusGMethodInfo dbus_glib_server_object_methods[] = {
  { (GCallback) server_echo_string, dbus_glib_marshal_server_object_BOOLEAN__STRING_POINTER_POINTER, 0 },
};
