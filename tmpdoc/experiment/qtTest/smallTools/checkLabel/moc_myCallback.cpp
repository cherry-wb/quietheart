...
**
** Created: Sat Mar 13 15:30:06 2010
...
static const uint qt_meta_data_ECheckLabel[] = {
...
static const char qt_meta_stringdata_ECheckLabel[] = {
    "ECheckLabel\0\0stateChanged(int)\0checked()\0"
};

const QMetaObject ECheckLabel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ECheckLabel,
      qt_meta_data_ECheckLabel, 0 }
};

const QMetaObject *ECheckLabel::metaObject() const
{
    return &staticMetaObject;
}

void *ECheckLabel::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ECheckLabel))
        return static_cast<void*>(const_cast< ECheckLabel*>(this));
    return QWidget::qt_metacast(_clname);
}

int ECheckLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void ECheckLabel::stateChanged(int _t1)
{
