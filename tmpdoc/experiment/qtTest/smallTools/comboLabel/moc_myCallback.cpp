...
**
** Created: Thu Mar 11 09:45:14 2010
...
static const uint qt_meta_data_EComboLabel[] = {
...
static const char qt_meta_stringdata_EComboLabel[] = {
    "EComboLabel\0\0activated(QString)\0"
    "clicked()\0activeItem()\0"
};

const QMetaObject EComboLabel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EComboLabel,
      qt_meta_data_EComboLabel, 0 }
};

const QMetaObject *EComboLabel::metaObject() const
{
    return &staticMetaObject;
}

void *EComboLabel::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EComboLabel))
        return static_cast<void*>(const_cast< EComboLabel*>(this));
    return QWidget::qt_metacast(_clname);
}

int EComboLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void EComboLabel::activated(const QString & _t1)
{
