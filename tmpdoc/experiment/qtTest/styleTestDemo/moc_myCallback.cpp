...
**
** Created: Mon May 10 10:26:13 2010
...
static const uint qt_meta_data_MyMenuItem[] = {
...
static const char qt_meta_stringdata_MyMenuItem[] = {
    "MyMenuItem\0"
};

const QMetaObject MyMenuItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyMenuItem,
      qt_meta_data_MyMenuItem, 0 }
};

const QMetaObject *MyMenuItem::metaObject() const
{
    return &staticMetaObject;
}

void *MyMenuItem::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyMenuItem))
        return static_cast<void*>(const_cast< MyMenuItem*>(this));
    return QWidget::qt_metacast(_clname);
}

int MyMenuItem::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
