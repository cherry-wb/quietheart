 ...
 then
   echo "String \"string1\" is not null." #输出这个,这里是错误的，因为string1没有正确引用
 else  
 ...
 then
   ...
   echo "String \"string1\" is null." #输出这个
 ...
 then
   echo "String \"string1\" is not null." #输出这个
 else  
   echo "String \"string1\" is null."
 fi  
 # 再来试一下, 给出了正确的结果.
