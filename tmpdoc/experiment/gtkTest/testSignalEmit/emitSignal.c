...
void button2_click(GtkWidget *widget, gpointer data)
{
	...
	g_print("emit clicked to button1\n");
	/*下面这句话是最最最最核心的，它负责发送消息到data*/
	 g_signal_emit_by_name(data, "clicked", NULL);
}
...
/*	gtk_window_set_accept_focus(GTK_WINDOW(window), FALSE);*/
	...
	button2 = gtk_button_new_with_label("emit \"click\" to button1 ");
	g_signal_connect(G_OBJECT(button2), "clicked",
			G_CALLBACK(button2_click), button1);
